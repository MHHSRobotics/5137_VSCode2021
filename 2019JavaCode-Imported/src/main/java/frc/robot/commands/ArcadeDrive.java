...
public class ArcadeDrive extends CommandBase {
	...
	public ArcadeDrive() { 
		addRequirements(Robot.driveBase_Subsystem);
	}

	public void execute() { /*As you can see, whenever ArcadeDrive is scheduled to execute (which,
	...
	protected boolean isFinished(boolean isInterrupted) {
		return false;
	}
